        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form className="space-y-6" action="#" method="POST">
            ...
            <div>
              <button
                type="submit"
                className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blinks-blue hover:bg-blinks-yellow focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blinks-blue"
              >
                Sign in
              </button>
            </div>
