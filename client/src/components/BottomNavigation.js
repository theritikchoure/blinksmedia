      ...
      <div className="flex">
        <div className="flex-1 group">
          ...
          >
            <span className="block px-1 pt-1 pb-2">
              ...
              <span className="block text-xs pb-1">For you</span>
            </span>
          </Link>
        </div>
        <div className="flex-1 group">
        ...
        {isUserLoggedIn && (<Fragment>
          <div className="flex-1 group">
            <button
              href="#"
              className="flex items-end justify-center text-center mx-auto px-4 pt-2 w-full text-gray-400 group-hover:text-blinks-primary border-b-2 border-transparent group-hover:border-blinks-primary"
            >
              <span className="block px-1 pt-1 pb-2">
                <span className="inline-flex justify-center items-center">
                  <svg
                ...
                <span className="block text-xs pb-1">Blink</span>
              </span>
            </button>
          </div>
          <div className="flex-1 group">
            ...
            >
              <span className="block px-1 pt-1 pb-2">
                ...
                <span className="block text-xs pb-1">Following</span>
              </span>
            </a>
          </div>
        </Fragment>)}
